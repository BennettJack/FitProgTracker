...
public class FptDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SetBlocTemplate>()
        ...
        modelBuilder.Entity<Muscle>().HasData(
            ...
            // Shoulders (1)
            new Muscle { Id = 1, MuscleName = "Front Delts", MuscleGroupId = 1 },
            new Muscle { Id = 2, MuscleName = "Side Delts", MuscleGroupId = 1 },
            new Muscle { Id = 3, MuscleName = "Rear Delts", MuscleGroupId = 1 },
            new Muscle { Id = 4, MuscleName = "Rotator Cuff", MuscleGroupId = 1 },

            // Upper Back (2)
            new Muscle { Id = 5, MuscleName = "Lats", MuscleGroupId = 2 },
            new Muscle { Id = 6, MuscleName = "Traps", MuscleGroupId = 2 },
            new Muscle { Id = 7, MuscleName = "Rhomboids", MuscleGroupId = 2 },
            new Muscle { Id = 8, MuscleName = "Teres Major", MuscleGroupId = 2 },
            new Muscle { Id = 9, MuscleName = "Rear Delts", MuscleGroupId = 2 },

            // Lower Back (3)
            new Muscle { Id = 10, MuscleName = "Erector Spinae", MuscleGroupId = 3 },
            new Muscle { Id = 11, MuscleName = "Lower Back", MuscleGroupId = 3 },

            // Arms (4)
            new Muscle { Id = 12, MuscleName = "Biceps", MuscleGroupId = 4 },
            new Muscle { Id = 13, MuscleName = "Triceps", MuscleGroupId = 4 },
            new Muscle { Id = 14, MuscleName = "Forearms", MuscleGroupId = 4 },
            new Muscle { Id = 15, MuscleName = "Brachialis", MuscleGroupId = 4 },
            new Muscle { Id = 16, MuscleName = "Brachioradialis", MuscleGroupId = 4 },

            // Legs (5)
            new Muscle { Id = 17, MuscleName = "Quads", MuscleGroupId = 5 },
            new Muscle { Id = 18, MuscleName = "Hamstrings", MuscleGroupId = 5 },
            new Muscle { Id = 19, MuscleName = "Glutes", MuscleGroupId = 5 },
            new Muscle { Id = 20, MuscleName = "Calves", MuscleGroupId = 5 },
            new Muscle { Id = 21, MuscleName = "Hip Flexors", MuscleGroupId = 5 },
            new Muscle { Id = 22, MuscleName = "Adductors (Inner Thigh)", MuscleGroupId = 5 },
            new Muscle { Id = 23, MuscleName = "Abductors (Outer Thigh)", MuscleGroupId = 5 },

            // Chest (6)
            new Muscle { Id = 24, MuscleName = "Upper Chest", MuscleGroupId = 6 },
            new Muscle { Id = 25, MuscleName = "Mid Chest", MuscleGroupId = 6 },
            new Muscle { Id = 26, MuscleName = "Lower Chest", MuscleGroupId = 6 },
            new Muscle { Id = 27, MuscleName = "Pecs", MuscleGroupId = 6 },

            // Core (7)
            new Muscle { Id = 28, MuscleName = "Upper Abs", MuscleGroupId = 7 },
            new Muscle { Id = 29, MuscleName = "Lower Abs", MuscleGroupId = 7 },
            new Muscle { Id = 30, MuscleName = "Obliques", MuscleGroupId = 7 },
            new Muscle { Id = 31, MuscleName = "Transverse Abs", MuscleGroupId = 7 }
        );
    }
}